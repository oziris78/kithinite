...
public class CurrentDev extends ApplicationAdapter {
    ...
    public void create() {
        ...
        pinNest.add(rectE, rectW, rectN, rectS, rectNE, rectNW, rectSE, rectSW, 
                rectNS, rectEW, rectNSE, rectNSW, rectNEW, rectSEW, rectNSEW);
        pinNest.add(rectNo);
        Gdx.graphics.setTitle("No pins (1/16)");
    }
    ...
    private void selectRect(Piece rectangle, String newTitle) {
        pinNest.forEachPiece(p -> p.setVisible(false)); // make them all invisible
